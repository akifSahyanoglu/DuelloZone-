...
const GecmisScreen = ({ navigation }) => {
  ...
  return (
    ...
    <View style={styles.sliderContainer}>
      <Swiper autoplay horizontal={false}
        height={200}
    ...
    <View style={styles.cardsWrapper}>
      <Text style={{
        ...
        fontWeight: 'bold',
        color: colors.text
      }}>Tamamlanmış Turnuvalar</Text>
      <View style={styles.card}>
        <View style={styles.cardImgWrapper}>
          <Image
            source={require('../assets/banners/junior.jpg')}
            resizeMode="cover"
            style={styles.cardImg}
          />
        </View>
        <View style={styles.cardInfo}>
          <Text style={styles.cardTitle}>Duello Zone Open Junior Turnuvası</Text>
        </View>
      </View>
    </View>
  </ScrollView>
